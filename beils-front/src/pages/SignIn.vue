			...
			<div class="mt-6">
				...
				<div class="mt-1">
					<input
						...
						autocomplete="email"
						required
						class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-beils-500 focus:border-beils-500 sm:text-sm"
					/>
				</div>
			</div>
